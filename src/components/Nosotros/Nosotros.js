    ...
    <div>
      <Container>
        ...
        <h5 className="text-center p-4 fst-italic ">
          "Unidos como una manada, tiramos todos para el mismo lado"
        </h5>
      </Container>
      <br />
      <Container className="container-fluid mb-5">
        <Row className="justify-content-around">
          ...
          <Col sm={6} md={3} className="my-2">
            ...
            <Card.Title className="text-center text-danger mt-1 pt-1">
              Nicolás Cortez D'Elia{' '}
            </Card.Title>
            <Card.Text className="text-center fw-bold">Scrum Master</Card.Text>
          </Col>
          <Col sm={6} md={3} className="my-2">
            <div className="text-center">
              {' '}
          ...
          <Col sm={6} md={3} className="my-2">
            ...
            <Card.Title className="text-center text-danger  mt-1">
              Luciano Hidalgo
            </Card.Title>
            <Card.Text className="text-center fw-bold">QA Tester</Card.Text>
          </Col>
        </Row>
      </Container>
    </div>
